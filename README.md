...
#### ui-ux-pro-max
! mkdir -p ~/.claude/skills/ui-ux-pro-max && curl -s https://raw.githubusercontent.com/nextlevelbuilder/ui-ux-pro-max-skill/main/.claude/skills/ui-ux-pro-max/SKILL.md -o ~/.claude/skills/ui-ux-pro-max/SKILL.md
```
